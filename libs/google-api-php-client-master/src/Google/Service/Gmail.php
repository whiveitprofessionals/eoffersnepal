...
class Google_Service_Gmail_UsersMessages_Resource extends Google_Service_Resource
{
   ...
   * require_once headers specified.
   ...
   * @opt_param string pageToken Page token to retrieve a specific page of results
   * in the list.
   * @opt_param bool includeSpamTrash require_once messages from SPAM and TRASH in the
   * results.
...
class Google_Service_Gmail_UsersThreads_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string pageToken Page token to retrieve a specific page of results
   * in the list.
   * @opt_param bool includeSpamTrash require_once threads from SPAM and TRASH in the
   * results.
