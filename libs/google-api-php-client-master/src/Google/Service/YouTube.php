...
class Google_Service_YouTube_Activities_Resource extends Google_Service_Resource
{
   ...
   *
   * The part names that you can require_once in the parameter value are snippet and
   * contentDetails.
   ...
   * The part names that you can require_once in the parameter value are id, snippet,
   * and contentDetails.
   *
...
class Google_Service_YouTube_ChannelSections_Resource extends Google_Service_Resource
{
   ...
   * include. The part names that you can require_once in the parameter value are id,
...
class Google_Service_YouTube_Channels_Resource extends Google_Service_Resource
{
   ...
   * properties that the API response will include.
   *
   * The part names that you can require_once in the parameter value are id and
   * invideoPromotion.
   *
...
class Google_Service_YouTube_LiveBroadcasts_Resource extends Google_Service_Resource
{
   ...
   * properties that the API response will include.
   *
   * The part properties that you can require_once in the parameter value are id,
   * snippet, contentDetails, and status.
   ...
   * API response to only require_once broadcasts with the specified status.
   * @opt_param string onBehalfOfContentOwner Note: This parameter is intended
   * exclusively for YouTube content partners.
   *
   * The onBehalfOfContentOwner parameter indicates that the request's
...
class Google_Service_YouTube_PlaylistItems_Resource extends Google_Service_Resource
{
   ...
   * properties that the API response will include.
   *
   * The part names that you can require_once in the parameter value are snippet,
...
class Google_Service_YouTube_Search_Resource extends Google_Service_Resource
{
   ...
   * mi. For example, valid parameter values require_once 1500m, 5km, 10000ft, and
   ...
   * results to only require_once videos with a particular license. YouTube lets video
   ...
   * restrict a search to only require_once either high definition (HD) or standard
   ...
   * search results should require_once restricted content as well as standard content.
...
class Google_Service_YouTube_Videos_Resource extends Google_Service_Resource
{
   ...
   * part names that you can require_once in the parameter value are id, snippet,
   * contentDetails, fileDetails, liveStreamingDetails, localizations, player,
   * processingDetails, recordingDetails, statistics, status, suggestions, and
   * topicDetails.
   *
