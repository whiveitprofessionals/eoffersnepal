...
class Google_Service_MapsEngine_Assets_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string maxResults The maximum number of items to require_once in a
...
class Google_Service_MapsEngine_TablesFeatures_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string maxResults The maximum number of items to require_once in the
   ...
   * @opt_param string require_once A comma separated list of optional data to include.
