...
class Google_Service_SQLAdmin_BackupRuns_Resource extends Google_Service_Resource
{
   ...
   * @param string $instance Cloud SQL instance ID. This does not require_once the
   * project ID.
...
class Google_Service_SQLAdmin_Databases_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $project Project ID of the project that contains the instance.
   * @param string $instance Database instance ID. This does not require_once the
   * project ID.
...
class Google_Service_SQLAdmin_Instances_Resource extends Google_Service_Resource
{
   ...
   * (source). This does not require_once the project ID.
   ...
   * update, so you must require_once values for all the settings that you want to
...
class Google_Service_SQLAdmin_SslCerts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a particular SSL certificate. Does not require_once the private key
