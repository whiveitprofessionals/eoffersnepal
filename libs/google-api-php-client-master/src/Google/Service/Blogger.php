...
class Google_Service_Blogger extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->blogUserinfo = new Google_Service_Blogger_BlogUserinfo_Resource(
        $this,
        $this->serviceName,
        'blogUserinfo',
        array(
    ...
    $this->postUserinfo = new Google_Service_Blogger_PostUserinfo_Resource(
        $this,
        $this->serviceName,
        'postUserinfo',
        array(
...
/**
 * The "blogUserinfo" collection of methods.
 * Typical usage is:
 *  <code>
 *   $bloggerService = new Google_Service_Blogger(...);
 *   $blogUserinfo = $bloggerService->blogUserinfo;
 *  </code>
 */
class Google_Service_Blogger_BlogUserinfo_Resource extends Google_Service_Resource
{

  /**
   * Gets one blog and user info pair by blogId and userId. (blogUserinfo.get)
   *
...
class Google_Service_Blogger_Blogs_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string status Blog statuses to require_once in the result (default:
   * Live blogs only). Note that ADMIN access is required to view deleted blogs.
   * @opt_param string role User access types for blogs to require_once in the results,
...
class Google_Service_Blogger_Comments_Resource extends Google_Service_Resource
{
   ...
   * RFC 3339 formatting.
   * @opt_param string maxResults Maximum number of comments to require_once in the
   * result.
...
/**
 * The "postUserinfo" collection of methods.
 * Typical usage is:
 *  <code>
 *   $bloggerService = new Google_Service_Blogger(...);
 *   $postUserinfo = $bloggerService->postUserinfo;
 *  </code>
 */
class Google_Service_Blogger_PostUserinfo_Resource extends Google_Service_Resource
{
   ...
   * rights, specific to the user. (postUserinfo.listPostUserinfo)
   *
   * @param string $userId ID of the user for the per-user information to be
   * fetched. Either the word 'self' (sans quote marks) or the user's profile
   * identifier.
   ...
   * @opt_param string view Access level with which to view the returned result.
   * Note that some fields require elevated access.
   * @return Google_Service_Blogger_PostUserinfoList
   */
  public function listPostUserinfo($userId, $blogId, $optParams = array())
  {
    $params = array('userId' => $userId, 'blogId' => $blogId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Blogger_PostUserinfoList");
  }
}
...
class Google_Service_Blogger_Posts_Resource extends Google_Service_Resource
{
   ...
   * included.
   * @opt_param string pageToken Continuation token if the request is paged.
   * @opt_param string status Statuses to require_once in the results.
   * @opt_param bool fetchBodies Whether the body content of posts is included
   * (default: true). This should be set to false when the post bodies are not
   * required, to help minimize traffic.
   * @opt_param string view Access level with which to view the returned result.
...
class Google_Service_Blogger_BlogList extends Google_Collection
{
  ...
  protected $blogUserinfoType = 'Google_Service_Blogger_BlogUserInfo';
  protected $blogUserinfoDataType = 'array';
  protected $itemsType = 'Google_Service_Blogger_Blog';
  protected $itemsDataType = 'array';
  public $kind;


  public function setBlogUserinfo($blogUserinfo)
  {
...
class Google_Service_Blogger_PostUserinfoList extends Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
