...
class Google_Service_Coordinate_Team_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool admin Whether to require_once teams for which the user has the
   * Admin role.
   * @opt_param bool worker Whether to require_once teams for which the user has the
   * Worker role.
   * @opt_param bool dispatcher Whether to require_once teams for which the user has
   * the Dispatcher role.
