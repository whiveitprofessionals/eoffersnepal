...
class Google_Service_Drive_About_Resource extends Google_Service_Resource
{
   ...
   * change IDs, whether to require_once public files the user has opened and shared
...
class Google_Service_Drive_Changes_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool includeSubscribed Whether to require_once public files the user
   ...
   * @opt_param bool includeDeleted Whether to require_once deleted items.
...
class Google_Service_Drive_Comments_Resource extends Google_Service_Resource
{
   ...
   * deleted comment, and will require_once any deleted replies.
   ...
   * @opt_param int maxResults The maximum number of discussions to require_once in the
...
class Google_Service_Drive_Permissions_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string emailMessage A custom message to require_once in notification
   * emails.
...
class Google_Service_Drive_Replies_Resource extends Google_Service_Resource
{
   ...
   * @opt_param int maxResults The maximum number of replies to require_once in the
   * response, used for paging.
